...
function Terms() {
  return (
    ...
    <article class="content">
      <span class="badge">Last updated: October 28, 2024</span>
      ...
      <p class="intro">Please read these terms and conditions carefully before using Our Service.</p>
        ...
        <p>Country refers to: Sri Lanka</p>
        <p>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to CodePRO LK, No 2/3, Hospital Juction, Polonnaruwa, Sri Lanka.</p>
        ...
        <p>Website refers to CodePRO LK, accessible from <a href="https://codeprolk.com/" target="_blank" rel="noopener noreferrer">https://codeprolk.com/</a></p>
        ...
        <div class="contact-card">By visiting this page on our website: <strong>CodePRO LK</strong></div>
    </article>
  </main>
      </div>
    </section>
